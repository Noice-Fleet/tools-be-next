...
export class RecipesResolver {
  ...
  async createRecipe(
    ...
    return this.commandBus.execute(new CreateRecipeCommand(newRecipeData, user))
  }
  ...
  async updateRecipe(
    ...
    return this.commandBus.execute(new UpdateRecipeCommand(updateRecipeData, user))
  }

  @UseGuards(GqlAuthGuard)
  @Mutation(() => Boolean)
  async deleteRecipe(@Args('id') id: string, @CurrentUser() user): Promise<Recipe> {
    return this.commandBus.execute(new DeleteRecipeCommand(id, user))
  }

  @UseGuards(GqlAuthGuard)
  @Mutation(() => Boolean)
  async shareRecipe(@Args('id') id: string, @CurrentUser() user): Promise<Recipe> {
