...
export class ReviewsResolver {
  ...
  async createReview(
    ...
    return this.commandBus.execute(new CreateReviewCommand(newReviewData, user))
  }
  ...
  async updateReview(
    ...
    return this.commandBus.execute(new UpdateReviewCommand(updateReviewData, user))
  }

  @UseGuards(GqlAuthGuard)
  @Mutation(() => Boolean)
  async deleteReview(@Args('id') id: string, @CurrentUser() user): Promise<Review> {
